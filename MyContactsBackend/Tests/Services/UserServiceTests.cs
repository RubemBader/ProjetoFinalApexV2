...
namespace Tests.Services
{
    public class UserServiceTests
    {
        ...
        public async Task DeleteAsync_QuandoNaoExistirUsuario_ReturnFalse()
        {
            // Preparação (Arrange)
            var userId = 1;
        ...
        public async Task GetAllAsync_Returna_List_De_UserResponseDto()
        {
            // Preparação (Arrange)
            var users = new List<User>
            {
                ...
                new User
                {
                    ...
                    Contacts = new List<Contact>
                    {
                        new Contact { Name = "Filha", Phone = "88889999" }
                    }
                }
            };
        ...
        public async Task UpdateAsync_QuandoExistirUsuario_UserRepository_Update_E_SaveChangesAsync_E_RetornaTrue()
        {
            // Preparação (Arrange)
        ...
        public async Task UpdateAsync_QuandoNaoExistirUsuario_RetornaFalse()
        {
            // Preparação (Arrange)
            var userUpdateDto = new UserUpdateRequestDto
            {
